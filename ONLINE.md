...
- Voice chat uses browser microphone permission and WebRTC. It needs HTTPS for remote play. Without a TURN server, a few strict networks may fail to connect peer-to-peer audio.
